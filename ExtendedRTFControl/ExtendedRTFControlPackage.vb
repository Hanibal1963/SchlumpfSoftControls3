...
<Guid(ExtendedRTFControlPackage.PackageGuidString)>
Public NotInheritable Class ExtendedRTFControlPackage
    Inherits AsyncPackage

    ''' <summary>
    ''' Package guid
    ''' </summary>
    Public Const PackageGuidString As String = "62af95bc-aacd-40b8-9846-90f8c6ce483b"
