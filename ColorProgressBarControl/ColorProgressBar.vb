...
#Region "Definition der öffentlichen Eigenschaften"
        ...
        Public Property Value() As System.Int32
            ...
            Set(value As System.Int32)
                ...
                Me._ProgressValue = System.Math.Max(0, System.Math.Min(value, Me._MaxValue))
                Me.UpdateProgress()
            End Set
        End Property
        ...
        Public Property ProgressMaximumValue() As System.Int32
            Get
                Return Me._MaxValue
            End Get
            Set(value As System.Int32)
                ' Der Maximalwert darf nie kleiner als 1 sein (Vermeidung Division durch 0).
                Dim minValue As System.Int32 = 1
                Dim boundedValue As System.Int32 = System.Math.Max(minValue, value)

                Me._MaxValue = boundedValue

                ' Falls der aktuelle Wert über dem neuen Maximum liegt, wird er automatisch reduziert.
                Me._ProgressValue = System.Math.Min(Me._ProgressValue, Me._MaxValue)
                Me.UpdateProgress()
            End Set
        End Property
...
#Region "Definition der internen Methoden"
        ...
        Private Sub UpdateGloss()
            ...
            Dim glossHeight As System.Int32 = System.Math.Max(0, Me.Height \ 3)
        ...
        Private Sub UpdateProgress()
            ...
            Dim fillWidth As System.Int32 = 0
            If Me._ProgressValue > 0 Then
                Dim ratio As System.Double = CDbl(Me._ProgressValue) / CDbl(Me._MaxValue)
                fillWidth = CInt(System.Math.Round(ratio * CDbl(Me.Width)))

                ' Ergebnis auf die Control-Breite begrenzen.
                fillWidth = System.Math.Max(0, System.Math.Min(Me.Width, fillWidth))
            End If
            ...
            Dim expectedPadding As System.Windows.Forms.Padding = If(Me._ShowBorder,
