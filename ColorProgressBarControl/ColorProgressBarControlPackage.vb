...
<Guid(ColorProgressBarControlPackage.PackageGuidString)>
Public NotInheritable Class ColorProgressBarControlPackage
    Inherits AsyncPackage

    ''' <summary>
    ''' Package guid
    ''' </summary>
    Public Const PackageGuidString As String = "4d029e07-e970-416f-b9e6-d2488f717b28"
