...
<Guid(SevenSegmentControlPackage.PackageGuidString)>
Public NotInheritable Class SevenSegmentControlPackage
    Inherits AsyncPackage

    ''' <summary>
    ''' Package guid
    ''' </summary>
    Public Const PackageGuidString As String = "48414612-e734-487b-a11e-da26abf2b93b"
