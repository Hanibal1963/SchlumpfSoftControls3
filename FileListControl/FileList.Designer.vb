...
Namespace FileListControl
    ...
    Partial Class FileList
        ...
        End Sub
        Private WithEvents listViewEntries As ListView
        Private WithEvents HeaderName As ColumnHeader
        Private WithEvents HeaderCreated As ColumnHeader
        Private WithEvents HeaderLastAccess As ColumnHeader
        Private WithEvents HeaderLastWrite As ColumnHeader
        Private WithEvents HeaderSize As ColumnHeader
        Private WithEvents HeaderType As ColumnHeader
    End Class
