...
<Guid(ImageComboBoxControlPackage.PackageGuidString)>
Public NotInheritable Class ImageComboBoxControlPackage
    Inherits AsyncPackage

    ''' <summary>
    ''' Package guid
    ''' </summary>
    Public Const PackageGuidString As String = "cd3a0fe0-1f35-4aa4-a42e-c4af2d8a63e0"
