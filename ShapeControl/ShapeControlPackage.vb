...
<Guid(ShapeControlPackage.PackageGuidString)>
Public NotInheritable Class ShapeControlPackage
    Inherits AsyncPackage

    ''' <summary>
    ''' Package guid
    ''' </summary>
    Public Const PackageGuidString As String = "405b3dea-4c93-4b9b-adf5-996d7ae2d2a3"
